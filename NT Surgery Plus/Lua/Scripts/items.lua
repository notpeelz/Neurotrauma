local experimentalEffects = {
  ...
  vigor = {
    weight = 3,
    afflictions = {
      { identifier = "strengthen", minstrength = 200, maxstrength = 400, limbspecific = false },
    },
  },
  haste = {
    weight = 3,
    afflictions = {
      { identifier = "haste", minstrength = 200, maxstrength = 400, limbspecific = false },
    },
  },
  psychosisresistance = {
    weight = 2,
  ...
  combatstimulant = {
    weight = 2,
    afflictions = {
      { identifier = "combatstimulant", minstrength = 30, maxstrength = 100, limbspecific = false },
    },
  },
  pressurestabilized = {
    weight = 1,
  ...
  bleeding = {
    weight = 1,
    afflictions = {
      { identifier = "bleeding", minstrength = 30, maxstrength = 80, limbspecific = true },
    },
  },
  burn = {
    weight = 1,
    afflictions = {
      { identifier = "burn", minstrength = 5, maxstrength = 20, limbspecific = true },
    },
  },
  explosiondamage = {
    weight = 1,
    afflictions = {
      { identifier = "explosiondamage", minstrength = 5, maxstrength = 20, limbspecific = true },
    },
  },
  gunshotwound = {
    weight = 1,
  ...
  stun = {
    weight = 1,
    afflictions = {
      { identifier = "stun", minstrength = 2, maxstrength = 15, limbspecific = false },
    },
  },
}
...
Hook.Add(
  "surgerybookgiveskill",
  "givesurgerybookskill",
